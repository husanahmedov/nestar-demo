      ...
      <Stack className="bottom">
        <Stack className="name-address">
          <Stack className="name">
            <Link href="/property/detail?id=test123sdijfsdf">
              <Typography>Seven Eleven Apartments</Typography>
            </Link>
          </Stack>

          <Stack className="address">
            <Typography>Seoul, Toksan Center 201 - 10</Typography>
          </Stack>
        </Stack>
        ...
        <Stack className="type-buttons">
          ...
          <Stack className="buttons">
            ...
            <Typography className="view-cnt">129</Typography>

            <IconButton color="default">
              <FavoriteIcon color="primary" />
            </IconButton>
            <Typography className="view-cnt">66</Typography>
          </Stack>
        </Stack>
      </Stack>
    </Stack>
